install: api-env api-composer-install api-build up sleep api-db-fresh api-key api-passport-key api-passport-generate
...
api-composer-install:
	docker compose exec -it api composer install --ignore-platform-reqs
