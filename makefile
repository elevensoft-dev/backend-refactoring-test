...
api-db:
	docker-compose exec -it api php /var/www/html/artisan migrate:fresh || docker compose exec -it api php /var/www/html/artisan migrate:fresh
	docker-compose exec -it api php /var/www/html/artisan db:seed || docker compose exec -it api php /var/www/html/artisan db:seed
